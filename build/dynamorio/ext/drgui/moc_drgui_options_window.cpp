...
#include "../../../../dynamorio/ext/drgui/drgui_options_window.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_drgui_options_window_t_t, stringdata) + ofs \
...
const QMetaObject drgui_options_window_t::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_drgui_options_window_t.data,
      qt_meta_data_drgui_options_window_t,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_drgui_options_window_t.stringdata))

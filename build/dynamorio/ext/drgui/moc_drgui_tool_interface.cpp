...
#include "../../../../dynamorio/ext/drgui/drgui_tool_interface.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_drgui_tool_interface_t_t, stringdata) + ofs \
...
const QMetaObject drgui_tool_interface_t::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_drgui_tool_interface_t.data,
      qt_meta_data_drgui_tool_interface_t,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_drgui_tool_interface_t.stringdata))
